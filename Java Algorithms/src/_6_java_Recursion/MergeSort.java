...
public class MergeSort {
	public static void main(String a[]) {
		...
		//mergeSort_s(array, 0, array.length -1);
	...
	public static void mergeSort_s(int array[], int lo, int n) {
		int low = lo;
		int high = n;
		...
		mergeSort_s(array, low, middle);
		mergeSort_s(array, middle + 1, high);
